...
namespace Лабораторная_работа_3
{
    public partial class MainForm : Form
    {
       ...
       float [,] matrRef = new float[3, 3];
        ...
        /// <summary>
        /// Итоговый массив для вывода на экран.
        /// </summary>
        float[,] kv1 = new float[4, 3];
        ...
        /// <summary>
        /// Создает итоговую фигуру для вывода на экран.
        /// </summary>
        private void CreateFinalFiqure()
        {
            kv1 = Multiply_matr(kv, matrRef); //перемножение матриц
        ...
        private void timer1_Tick_1(object sender, EventArgs e)
        {
            ...
            else 
            {
                ...
                MessageBox.Show("Вы не выбрали направление движения");
                isStart = !isStart;
            }
        }
